<template>
  <div class="relative isolate overflow-hidden bg-gray-900">
    ...
    <div
      ...
      aria-hidden="true">
      <div class="aspect-[1108/632] w-[69.25rem] bg-gradient-to-r from-blue-400 to-indigo-600 opacity-20"
    ...
    <div class="mt-[-50px] flex h-screen items-center justify-center">
      <div class="max-w-full flex-shrink-0 px-4 text-center lg:mx-0 lg:max-w-3xl lg:pt-8">
        <h1 class="mt-10 text-5xl font-bold tracking-tight text-white sm:text-6xl">
          ...
          <span class="text-blue-500">poder da divulgação</span><br />
          através do <span class="text-blue-500">Ararion</span>
        </h1>
